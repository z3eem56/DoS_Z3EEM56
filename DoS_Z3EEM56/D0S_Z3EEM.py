...
if Kl == 'Y':
    ...
    if la == 'Y':
        ...
        for i in range(threads):
            ...
            print("Maybe the target has been shytd0wn")
...
if la == 'n':
    ...
    for i in range(threads):
        ...
        print("Maybe the server has been shutd0wn or you have a bad connection")

    print("{*}attack has been stop! Thank you to use my tool <3 See you later & Do not Forget to follow Me in IG & YT & TW <:")
    print("{*}Going out...")
    sleep(8)